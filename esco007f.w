...
DEFINE VARIABLE cb-justif AS CHARACTER FORMAT "X(256)":U 
     LABEL "Justificativa" 
     VIEW-AS COMBO-BOX INNER-LINES 5
     LIST-ITEM-PAIRS "Marca Homologada","1",
...
------------------------------------------------------------------------------*/
  ...
  If Avail mgcolomb.cot-ordem Then Do:
     Assign Input Frame {&frame-name} ed-narrativa:screen-value = mgcolomb.cot-ordem.narrativa-item 
            INPUT FRAME {&FRAME-NAME} cb-justif:SCREEN-VALUE    = if cot-ordem.cod-justif = 0 then "1" else string(cot-ordem.cod-justif).
  End.
